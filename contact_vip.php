...
<html>
 ...
 <body>
        <p>Новая заявка с сайта http://go.decormehedova.ru/landing/kursi-decora-ukraine на участие в тренинге 14, 15, 16 мая 2015 года:</p>
        <p>Имя: '.htmlspecialchars($_REQUEST['name']).'</p>
		<p>E-mail: '. htmlspecialchars($_REQUEST['email']).'</p>   
        <p>Телефон: '. $_REQUEST['phone'].'</p>
        <p>Заказанный пакет услуг: VIP </p>
    </body>
</html>';
